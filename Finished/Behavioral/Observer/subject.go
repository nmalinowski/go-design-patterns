...
// DONE: The ChangeItem function will cause the Listeners to be called
...
// DONE: This function adds an observer to the list
func (ds *DataSubject) registerObserver(o DataListener) {
	ds.observers = append(ds.observers, o)
}

// DONE: This function removes an observer from the list
...
// DONE: The notifyAll function calls all the listeners with the changed data
