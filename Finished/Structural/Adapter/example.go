...
func main() {
	...
	// DONE: Because the SohneeTV implements the "television" interface, we don't need an adapter
	tv2.turnOn()
	tv2.volumeUp()
	tv2.volumeDown()
	tv2.channelUp()
	...
	// DONE: We need to create a SammysangTV adapter for the SammysangTV class, however
